...
underestimation. This historical 50{,}000-block sweep supports the
relative load mechanism, not calibrated absolute error.
...
reusing the retrieval embedding already computed per chunk to route
